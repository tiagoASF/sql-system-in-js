...
2 - Instruções
    ...
    2.1 - Crie um método chamado "delete".
    2.2 - Na função "execute", invoque o método "delete".
    2.3 - Extraia a cláusula where do comando.
    2.4 - Crie as variáveis columnWhere e valueWhere.
    2.5 - Filtre os registros conforme a cláusula where.
    2.6 - Exclua os registros.
...
let database = {
    ...
    delete(query) {
        ...
        const queryParameters = query.match(regExp);
        [, tableName, column] = queryParameters;
        column = column.split(" = ");
        [columnWhere, columnValue] = column;        
